...
class TrainingArguments(transformers.TrainingArguments):
    ...
    #     default="linear",
    #     metadata={"help": "Learning rate scheduler type. Choose from: linear, cosine, cosine_with_restarts, polynomial, constant, constant_with_warmup"}
    # )
    # warmup_steps: int = field(
    #     default=0, metadata={"help": "Number of steps for warmup"}
    # )
